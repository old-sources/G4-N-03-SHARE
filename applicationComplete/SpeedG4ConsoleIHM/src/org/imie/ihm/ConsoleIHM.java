...
public class ConsoleIHM implements IIHM{
	IFactory fact;
	...
	public ConsoleIHM(IFactory fact) {
		super();
		this.fact = fact;
	}
	...
	public void start() {
		...
		IEcoleService ecoleService = fact.createEcoleService();
	...
	private PersonneDTO typePersonne(Scanner scanner,
	...
	private Date typeDate(Scanner scanner, SimpleDateFormat simpleDateFormat,
			String dateTypingLabel) {
		Date dateNaiss = null;
	...
	private String specifyNull(Scanner scanner, String saisie) {
		if (saisie.isEmpty()) {
	...
	private void displayListPersonne(List<PersonneDTO> dtos,
			SimpleDateFormat simpleDateFormat) {
		Integer i = 1;
	...
	private void displayListPromotion(List<PromotionDTO> dtos,
			SimpleDateFormat simpleDateFormat) {
		Integer i = 1;
	...
	private void displayPromotion(PromotionDTO promotionDTO,
			SimpleDateFormat simpleDateFormat) {
	...
	private void displayPersonne(PersonneDTO personneDTO,
			SimpleDateFormat simpleDateFormat) {
